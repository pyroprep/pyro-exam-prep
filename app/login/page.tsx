        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <label
                htmlFor="email"
                className="block text-[11px] font-mono uppercase tracking-widest text-zinc-500 mb-1.5"
              >
                Email
              </label>
              <input
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-lg bg-orange-600 hover:bg-orange-500 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-semibold uppercase tracking-wider py-3 transition-colors"
            >
          ...
          {/* Sign-up link */}
          <p className="mt-6 text-center text-xs text-zinc-600 font-mono uppercase tracking-wider">
            No account?{" "}
            <Link
              href="/signup"
